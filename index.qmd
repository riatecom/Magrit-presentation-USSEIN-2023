...
# Données quantités absolues (stocks)
...
Les fournisseurs de données géographiques fournissent régulièrement plusieurs niveaux de généralisation, comme **Natural Earth**.
...
-   À l'**échelle mondiale** : Natural Earth (géométries) / Nations Unies (Population prospect) : pays définis par des codes ISO uniques.
-   À l'**échelle européenne** : GISCO (géométries) / Eurostat (données socio-économiques). Régions européennes définies par la nomenclature **NUTS**.
-   À l'**échelle française** : IGN (géométries) / INSEE. Plusieurs découpages disponibles (communes, EPCI, etc.)

:::

::: {.column width="49%"}

Données de population communales de l'INSEE ![](images/insee.png)
...
::: {.column width="49%"}
Données de population communales de l'INSEE ![](images/ign.png)
:::
...
## Pour conclure sur l'information géographique
